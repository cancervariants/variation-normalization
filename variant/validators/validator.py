...
import logging
from variant.validators.genomic_base import GenomicBase
...
class Validator(ABC):
    ...
    def human_description(self, transcript, token) -> str:
        ...
        :return: Human description of the variant change
        """
        raise NotImplementedError
    ...
    def validates_classification_type(self,
        ...
        :param str classification_type: The type of variant
    ...
    def get_validation_result(self, classification, is_valid, confidence_score,
        ...
        :param str human_description: A human description describing the
            variant
        :param str concise_description: HGVS expression for variant
    ...
    def get_protein_transcripts(self, gene_tokens, errors)\
            -> Optional[List[str]]:
        """Get transcripts for variants with protein reference sequence.

        :param list gene_tokens: List of gene tokens for a classification
        :param list errors: List of errors
        :return: List of possible transcript accessions for the variant
        """
    ...
    def get_coding_dna_transcripts(self, gene_tokens, errors)\
            -> Optional[List[str]]:
        """Get transcripts for variants with coding DNA reference sequence.
    ...
    def get_genomic_transcripts(self, classification, errors)\
            -> Optional[List[str]]:
        """Get NC accessions for variants with genomic reference sequence.

        :param Classification classification: Classification for a list of
            tokens
        :param list errors: List of errors
        :return: List of possible NC accessions for the variant
        """
