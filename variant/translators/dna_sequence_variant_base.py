"""Module for DNA Sequence Variant Translation Base Class."""
...
class DNASequenceVariantBase(Translator):
    """DNA Sequence Variant Translation Base class."""

    def translate(self, res: ValidationResult) -> Allele:
        """Translate to VRS representation."""
        sub_tokens = [t for t in res.classification.all_tokens if
