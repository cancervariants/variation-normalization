...
class UTA:
    ...
    def __init__(self, db_url: str = UTA_DB_URL, db_pwd: Optional[str] = None) -> None:
    ...
    def _update_db_url(self, db_pwd: str, db_url: str) -> Optional[str]:
    ...
    def _get_conn_args(self, is_prod: bool, db_pwd: str, db_url: str) -> Dict:
        ...
        if not is_prod:
            ...
            return self._get_args(url.hostname, int(url.port), url.database,
                                  url.username, urllib.parse.unquote(url.password))
        else:
    ...
    def _url_encode_password(self, db_url: str) -> str:
        ...
        return db_url.replace(original_pwd, urllib.parse.quote(original_pwd))
    ...
    def _create_genomic_table(self) -> None:
    ...
    def get_cds_start_end(self, ac: str) -> Optional[Dict[int, int]]:
    ...
    def get_newest_assembly_ac(self, ac: str) -> Optional[List]:
    ...
    def validate_genomic_ac(self, ac: str) -> StrictBool:
    ...
    def get_ac_descr(self, ac: str) -> Optional[str]:
    ...
    def get_tx_exon_aln_v_data(self, ac: str, start_pos: int, end_pos: int,
                               alt_ac: Optional[int] = None,
                               use_tx_pos: bool = True) -> Optional[List]:
        ...
        :param Optional[int] alt_ac: NC accession
    ...
    def data_from_result(self, result: List) -> Optional[Dict]:
    ...
    def get_mane_c_genomic_data(self, ac: str, alt_ac: str, start_pos: int,
    ...
    def get_genomic_tx_data(self, ac: str, pos: int) -> Optional[Dict]:
    ...
    def get_ac_from_gene(self, gene: str) -> Optional[List[str]]:
    ...
    def get_gene_from_ac(self, ac: str, start_pos: int, end_pos: int) -> Optional[str]:
    ...
    def get_chr_assembly(self, ac: str) -> Optional[Tuple[str, str]]:
    ...
    def liftover_to_38(self, genomic_tx_data: Dict) -> None:
    ...
    def _set_liftover(self, genomic_tx_data: Dict, key: str, chromosome: str) -> None:
    ...
    def p_to_c_ac(self, p_ac: str) -> List[str]:
...
class ParseResult(urlparse.ParseResult):
    ...
    def __new__(cls, pr: urllib.parse.ParseResult):  # noqa: ANN204
        """Create new instance."""
