...
class CdnaDelIns(Translator):
    ...
    def can_translate(self, type: ClassificationType) -> bool:
        """Return if classification type is Cdna DelIns."""
        return type == ClassificationType.CDNA_DELINS
    ...
    async def translate(
        ...
        if endpoint_name == Endpoint.NORMALIZE:
            mane = await self.mane_transcript.get_mane_transcript(
                ...
                CoordinateType.CDNA, end_pos=classification.pos1,
            ...
            if mane:
                ...
                vrs_allele = self.vrs.to_vrs_allele(
                    ...
                    CoordinateType.CDNA, AltType.DELINS, warnings,
