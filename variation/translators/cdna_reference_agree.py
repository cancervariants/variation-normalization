"""Module for Cdna Reference Agree Translation."""
...
class CdnaReferenceAgree(Translator):
    """The Cdna Reference Agree Translator class."""

    def can_translate(self, type: ClassificationType) -> bool:
        """Return if classification type is Cdna Reference Agree."""
        return type == ClassificationType.CDNA_REFERENCE_AGREE
    ...
    async def translate(
        ...
        classification: CdnaReferenceAgreeClassification = validation_result.classification  # noqa: E501
        vrs_allele = None
        vrs_seq_loc_ac = None
        ...
        if endpoint_name == Endpoint.NORMALIZE:
            ...
            if mane:
                ...
                vrs_allele = self.vrs.to_vrs_allele(
                    ...
                    CoordinateType.CDNA, AltType.REFERENCE_AGREE, warnings,
