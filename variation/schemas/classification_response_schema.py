...
class ProteinSubstitutionClassification(Classification, Substitution):
    ...
    molecule_context: Literal[MoleculeContext.PROTEIN] = MoleculeContext.PROTEIN
...
class GenomicSubstitutionClassification(Classification, Substitution):
    ...
    molecule_context: Literal[MoleculeContext.GENOMIC] = MoleculeContext.GENOMIC
...
class CdnaSubstitutionClassification(Classification, Substitution):
    ...
    molecule_context: Literal[MoleculeContext.TRANSCRIPT] = MoleculeContext.TRANSCRIPT
