"""Test that parsed_to_cn_cnv works correctly"""
import pytest
...
def test_parsed_copy_number_gain(test_cnv_handler, copy_number_gain1,
                                 copy_number_gain2):
...
def test_parsed_copy_number_loss(test_cnv_handler, copy_number_loss1,
                                 copy_number_loss2):
    """Test that parsed_to_cn_cnv works for parsed copy number loss queries"""
